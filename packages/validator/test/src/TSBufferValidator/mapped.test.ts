...
describe('MappedType Validate', function () {
  ...
  it('Pick', function () {
    ...
    validateAndAssert(
      { name: 'x', orders: [] },
      'mapped/Pick1',
      ErrorMsg[ErrorType.ExcessProperty]('orders')
    );
    validateAndAssert(
      {},
      'mapped/Pick1',
    ...
    ['Pick2', 'Pick2_1', 'Pick2_2', 'Pick2_3', 'Pick2_4'].forEach((v) => {
      ...
      validateAndAssert(
        { name: 'x', orders: [1, 2, 3], sex: { value: 'm' } },
        `mapped/${v}`,
    ...
    validateAndAssert(
      { name: 'x', orders: [1] },
      'mapped/Pick3',
      ErrorMsg[ErrorType.ExcessProperty]('name')
    );
    ...
    validateAndAssert(
      ...
      'mapped/PickAB',
      ErrorMsg[ErrorType.ExcessProperty]('valueA')
    );
    validateAndAssert(
      {
        common: 'xxx',
    ...
    ['PickIntersection1', 'OmitIntersection1'].forEach((v) => {
      ...
      validateAndAssert(
        { c: 'x' },
        'mapped/' + v,
        ErrorMsg[ErrorType.MissingRequiredProperty]('a')
      );
      validateAndAssert(
        { a: 'x', b: 'x', c: 'x' },
        'mapped/' + v,
        ErrorMsg[ErrorType.ExcessProperty]('b')
      );
    });
    ...
    ['PickIntersection2', 'OmitIntersection2'].forEach((v) => {
      ...
      validateAndAssert(
        { type: 'b' },
        'mapped/' + v,
        ErrorMsg[ErrorType.MissingRequiredProperty]('value')
      );
      validateAndAssert(
        { type: 'b', value: { b: 'x' }, meta: 'xxx' },
        'mapped/' + v,
        ErrorMsg[ErrorType.ExcessProperty]('meta')
      );
      validateAndAssert(
        { type: 'b', value: { a: 'x' } },
        'mapped/' + v,
        ErrorMsg[ErrorType.ExcessProperty]('a'),
        ['value']
      );
    });
  });
  ...
  it('Partial', function () {
    ...
    validateAndAssert(
      { a: 'x', c: undefined },
      'mapped/IPartial',
      ErrorMsg[ErrorType.TypeError]('string | number', 'undefined'),
      ['c']
    );

    // PartialAB
    validateAndAssert(
      { type: 'A', valueA: 'AAA', common: 'xxx' },
      'mapped/PartialAB',
      undefined
    );
    validateAndAssert(
  ...
  it('Omit', function () {
    ...
    validateAndAssert(
      ...
      'mapped/OmitAB',
      ErrorMsg[ErrorType.MissingRequiredProperty]('valueA')
    );
    validateAndAssert(
      {
        type: 'A',
    ...
    validateAndAssert(
      ...
      'mapped/OmitAB',
      ErrorMsg[ErrorType.ExcessProperty]('common')
    );
  });
  ...
  it('Nested Pick<A|B> Omit<A|B>', function () {
    ...
    validateAndAssert(
      ...
      'mapped/NestedAB',
      ErrorMsg[ErrorType.ExcessProperty]('type')
    );
    validateAndAssert(
      {
        type: 'A',
    ...
    validateAndAssert(
      ...
      'mapped/NestedAB',
      ErrorMsg[ErrorType.ExcessProperty]('common2')
    );
  });
  ...
  it('Overwrite', function () {
    ...
    validateAndAssert(
      ...
      'mapped/Overwrite1',
      'Property `sex`: ' + ErrorMsg[ErrorType.TypeError]('string', 'Object')
    );
    validateAndAssert(
      {
        name: 'x',
  ...
  it('NonNullable', function () {
    validateAndAssert(
      undefined,
      'mapped/NonNullable1',
      ValidateResultUtil.error(ErrorType.TypeError, 'NonNullable', 'undefined')
        .errMsg
    );
    validateAndAssert(
      undefined,
    ...
    validateAndAssert(
      null,
      'mapped/NonNullable1',
      ValidateResultUtil.error(ErrorType.TypeError, 'NonNullable', 'null')
        .errMsg
    );
    validateAndAssert(
      null,
  ...
  it('Interface extends Pick/Omit', async function () {
    validateAndAssert(
      { name: 'x' },
      'mapped/ExtendPick2',
      ErrorMsg[ErrorType.MissingRequiredProperty]('xxx')
    );
    validateAndAssert({ name: 'x', xxx: 'x' }, `mapped/ExtendPick2`, undefined);
    validateAndAssert({ name: 'x', xxx: 'x' }, `mapped/ExtendPick2`, undefined);
    validateAndAssert(
      { name: 'x', xxx: 'x', orders: [1, 2, 3] },
      `mapped/ExtendPick2`,
      undefined
    );
    validateAndAssert(
      { name: 'x', xxx: 'x', orders: [1, 2, 3], sex: { value: 'm' } },
      `mapped/ExtendPick2`,
      ErrorMsg[ErrorType.ExcessProperty]('sex')
    );
    ...
    validateAndAssert(
      { name: 'x', xxx: 'x', orders: [1] },
      'mapped/ExtendOmit2',
      ErrorMsg[ErrorType.ExcessProperty]('orders')
    );
    validateAndAssert(
      { name: 'x', xxx: 'x', sex: { value: 'f' } },
      'mapped/ExtendOmit2',
      ErrorMsg[ErrorType.ExcessProperty]('sex')
    );
    validateAndAssert(
