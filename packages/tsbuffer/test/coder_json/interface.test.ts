...
describe('Interface', function () {
    it('property', async function () {
        ...
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({ a: 'xxxx', b: undefined }, 'a/b').json!)), 'a/b').value, { a: 'xxxx' });
    })
    ...
    it('Pick/Omit嵌套', async function () {
        ...
        let tsb = new TSBuffer(proto);
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            a: 'aaa',
            b: 'aaa',
            c: 'aaa'
        }, 'a/b1').json!)), 'a/b1').value, { a: 'aaa' });
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            a: 'aaa',
            b: 'aaa',
            c: 'aaa'
        }, 'a/b2').json!)), 'a/b2').value, { a: 'aaa' });

        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            a: 'aaa',
            b: 'aaa',
            c: 'aaa'
        }, 'a/b').json!)), 'a/b1').value, { a: 'aaa' });
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            a: 'aaa',
            b: 'aaa',
            c: 'aaa'
        }, 'a/b').json!)), 'a/b2').value, { a: 'aaa' });
    });
    ...
    it('Pick', async function () {
        ...
        assert.
            deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
                a: 'str',
                b: 123,
                c: { value: 'ccc' }
            }, 'a/b').json!)), 'a/b').value, {
    ...
    it('Pick keyof', async function () {
        ...
        ['a/b', 'a/b1', 'a/b2'].forEach(v => {
            assert.deepStrictEqual(tsb.decodeJSON(tsb.encodeJSON({
                a: 'str',
                b: 123,
                c: { value: 'ccc' }
            }, v).json!, v).value, {
    ...
    it('AllowUnknownFields', async function () {
        ...
        [
            ...
            assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb1.encodeJSON(v1, 'a/b').json!)), 'a/b').value, v);
            assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb1.encodeJSON(v2, 'a/b').json!)), 'a/b').value, v);
        });
    })
    ...
    it('Pick<A|B>', async function () {
        ...
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            ...
            common1: 'asdgasdg',
            common2: 'asdgasdg'
        }, 'a/TestPick').json!)), 'a/TestPick').value, { type: 'a1' });
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            type: 'a2',
            a1: 'asdg',
            a2: 'gdasee',
            common1: 'asdgasdg',
            common2: 'asdgasdg'
        }, 'a/union').json!)), 'a/TestPick').value, { type: 'a2' });
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            type: 'a2',
            a1: 'asdg',
            a2: 'gdasee',
            common1: 'asdgasdg',
            common2: 'asdgasdg'
        }, 'a/TestPick').json!)), 'a/union').value, { type: 'a2' });
        ...
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            ...
            common1: 'asdgasdg',
            common2: 'asdgasdg'
        }, 'a/TestOmit').json!)), 'a/TestOmit').value, {
            type: 'a1',
            a1: 'asdg',
            common2: 'asdgasdg'
        });
        ...
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
            ...
            common1: 'asdgasdg',
            common2: 'asdgasdg'
        }, 'a/PickOmit').json!)), 'a/PickOmit').value, {
            type: 'a1',
            common2: 'asdgasdg'
        });
        assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON({
...
export type NonNullable4 = NonNullable<Wrapper['value4']>;
        ...
        ['a/NonNullable1', 'a/NonNullable2', 'a/NonNullable3'].forEach(schemaId => {
            assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON('AAA', schemaId).json!)), schemaId).value, 'AAA');
        });
        ...
        [
            ...
            assert.deepStrictEqual(tsb.decodeJSON(JSON.parse(JSON.stringify(tsb.encodeJSON(v, 'a/NonNullable4').json!)), 'a/NonNullable4').value, v);
        });
    })
})