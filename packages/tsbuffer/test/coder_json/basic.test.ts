...
describe('Basic Encode', function () {
  ...
  it('Enum', async function () {
    ...
    [
      ...
      assert.strictEqual(
        tsb.decodeJSON(
          JSON.parse(JSON.stringify(tsb.encodeJSON(v, 'a/TestEnum').json!)),
          'a/TestEnum'
        ).value,
        v
      );
  ...
  it('Literal', function () {
    ...
    (
      ...
      assert.deepStrictEqual(
        tsb.decodeJSON(
          JSON.parse(JSON.stringify(tsb.encodeJSON(v[1], 'a/' + v[0]).json!)),
          'a/' + v[0]
        ).value,
        v[1]
      );
  ...
  it('Buffer', function () {
    ...
    let decode = tsb.decodeJSON(
      JSON.parse(JSON.stringify(tsb.encodeJSON(buf.buffer, 'a/b').json!)),
      'a/b'
    ).value;
    ...
    for (let key in typedArrays) {
      ...
      assert.deepStrictEqual(
        tsb.decodeJSON(
          JSON.parse(JSON.stringify(tsb.encodeJSON(arr1, 'a/b').json!)),
          'a/b'
        ).value,
        arr1,
        key + ' failed'
      ...
      assert.deepStrictEqual(
        tsb.decodeJSON(
          JSON.parse(JSON.stringify(tsb.encodeJSON(arr, 'a/b').json!)),
          'a/b'
        ).value,
        arr,
        key + ' failed'
  ...
  it('Date', function () {
    ...
    let decoded = tsb.decodeJSON(JSON.parse(JSON.stringify(encoded)), 'a/b')
      .value as Date;
