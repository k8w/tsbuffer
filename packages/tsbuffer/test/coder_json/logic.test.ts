...
describe('LogicTypes', function () {
  it('A | B', async function () {
    ...
    assert.deepStrictEqual(
      tsb.decodeJSON(
        JSON.parse(JSON.stringify(tsb.encodeJSON(null, 'a/b2').json!)),
        'a/b2'
      ).value,
      null
    );
    assert.deepStrictEqual(
      tsb.decodeJSON(
        JSON.parse(JSON.stringify(tsb.encodeJSON([null], 'a/arr').json!)),
        'a/arr'
      ).value,
      [null]
    );
  ...
  it('Unknown Union ID', async function () {
    ...
    [
      ...
      assert.deepStrictEqual(
        tsb.decodeJSON(
          JSON.parse(JSON.stringify(tsb.encodeJSON(v, 'a/a').json!)),
          'a/a1'
        ).value,
        v
      );
      ...
      assert.deepStrictEqual(
        tsb.decodeJSON(
          JSON.parse(JSON.stringify(tsb.encodeJSON(v1, 'a/a1').json!)),
          'a/a'
        ).value,
        v
      );
  ...
  it('Unknown Intersection ID', async function () {
    ...
    assert.deepStrictEqual(
      tsb.decodeJSON(
        JSON.parse(JSON.stringify(tsb.encodeJSON(v, 'a/a1').json!)),
        'a/a'
      ).value,
      v
    );
  ...
  it('Partial<Pick>> & { xxx: string }', async function () {
    ...
    let dec = tsb.decodeJSON(
      JSON.parse(JSON.stringify(enc.json!)),
      'a/UpdatePost'
    );
